...
#     else:
#         # Not a HTTP POST, so we render our form using two ModelFrom instances.
...
#     else:
#         return render(request, 'rango/login_old.html', context_dict)
...
def about(request):
    context_dict = {'message': "This tutorial has been put together by ANTI-MUSOR"}
    visitor_cookie_handler(request)
    context_dict['visits'] = request.session['visits']
    context_dict['last_visit'] = request.session['last_visit']
...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        # Don't do anything -
        # the template will display the "no category" massage for us.
